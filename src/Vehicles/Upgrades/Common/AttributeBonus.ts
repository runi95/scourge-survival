...
export class AttributeBonus extends VehicleUpgrade {
  ...
  public readonly description =
    "Increases Strength, Agility and Intelligence by +3 points.";

  public applyUpgrade(vehicle: Vehicle): void {
    vehicle.unit.setStrength(vehicle.unit.strength + 3, true);
    vehicle.unit.setAgility(vehicle.unit.agility + 3, true);
    vehicle.unit.setIntelligence(vehicle.unit.intelligence + 3, true);
  }
}
