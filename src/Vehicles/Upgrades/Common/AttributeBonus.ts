...
export class AttributeBonus extends VehicleUpgrade {
  ...
  public readonly description =
    "Increases Strength, Agility and Intelligence by +4 points.";

  public applyUpgrade(vehicle: Vehicle): void {
    vehicle.unit.setStrength(vehicle.unit.strength + 4, true);
    vehicle.unit.setAgility(vehicle.unit.agility + 4, true);
    vehicle.unit.setIntelligence(vehicle.unit.intelligence + 4, true);
  }
}
