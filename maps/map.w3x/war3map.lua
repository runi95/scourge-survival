...
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), -11520.0, -1920.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), -11520.0, 7296.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), -11520.0, -11264.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), -2304.0, -11264.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), 6912.0, -11264.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), -2304.0, -1920.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), 6912.0, -1920.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), 6912.0, 7296.0, 270.000, FourCC("n00D"))
u = BlzCreateUnitWithSkin(p, FourCC("n00D"), -2304.0, 7296.0, 270.000, FourCC("n00D"))
end
...
SetPlayerRaceSkin(Player(8), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(9), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(10), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(12), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(13), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(14), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(15), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(16), RACE_PREF_USER_SELECTABLE)
...
SetPlayerRaceSkin(Player(17), RACE_PREF_USER_SELECTABLE)
...
function main()
SetCameraBounds(-15616.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -13824.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 13440.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 15360.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -15616.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 15360.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 13440.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -13824.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
SetDayNightModels("Environment\\DNC\\DNCLordaeron\\DNCLordaeronTerrain\\DNCLordaeronTerrain.mdl", "Environment\\DNC\\DNCLordaeron\\DNCLordaeronUnit\\DNCLordaeronUnit.mdl")
SetTerrainFogExV(0, 3000.0, 5000.0, 0.500, 0.0, 0.0, 10000.0, 10000.0, 1.000, 0.000, 0.000)
...
DefineStartLocation(1, -1152.0, 10112.0)
DefineStartLocation(2, 8064.0, 10112.0)
DefineStartLocation(3, -10368.0, 832.0)
DefineStartLocation(4, -1152.0, 832.0)
DefineStartLocation(5, 8064.0, 896.0)
DefineStartLocation(6, -10368.0, -8512.0)
DefineStartLocation(7, -1152.0, -8448.0)
DefineStartLocation(8, 8064.0, -8512.0)
DefineStartLocation(9, -10368.0, 10112.0)
DefineStartLocation(10, -1152.0, 10112.0)
DefineStartLocation(11, 8064.0, 10112.0)
DefineStartLocation(12, -10368.0, 832.0)
DefineStartLocation(13, -1152.0, 832.0)
DefineStartLocation(14, 8064.0, 896.0)
DefineStartLocation(15, -10368.0, -8512.0)
DefineStartLocation(16, -1152.0, -8448.0)
DefineStartLocation(17, 8064.0, -8512.0)
